...
const S = {
  ...
  webBtn: (on: boolean) => ({ padding: '3px 6px', borderRadius: 5, fontSize: 7, fontWeight: 700, border: `1px solid ${on ? 'rgba(96,165,250,.25)' : 'rgba(96,165,250,.1)'}`, background: on ? 'rgba(96,165,250,.12)' : 'var(--accent-primary),rgba(167,139,250,.08))', color: 'var(--wp-blue)', cursor: 'pointer', fontFamily: 'var(--wp-font)' }),
