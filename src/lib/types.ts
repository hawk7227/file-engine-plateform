...
export const PLAN_LIMITS = {
  free: { concurrent: 3, daily: 10, generations_per_day: 10 },
  pro: { concurrent: 10, daily: 100, generations_per_day: 100 },
  enterprise: { concurrent: 20, daily: 999999, generations_per_day: 999999 }
} as const
