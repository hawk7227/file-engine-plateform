  ...
  try {
    ...
    if (repoExists) {
      ...
      result = await pushFiles(owner, sanitizedRepoName, body.files, {
        branch: body.branch,
        commitMessage: body.commitMessage || 'Update from File Engine',
        token: githubToken
      });
      ...
      result = await createRepoAndPush(sanitizedRepoName, body.files, {
        description: 'Generated by File Engine',
        private: body.isPrivate,
        commitMessage: body.commitMessage || 'Initial commit from File Engine',
        token: githubToken
      });
